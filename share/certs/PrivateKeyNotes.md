...
unlocked to sign the Wankcoin-Qt.app bundle.
...
allowing somebody to distribute a Wankcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the wankcoin-qt.exe file inside the installer had not been tampered with.
